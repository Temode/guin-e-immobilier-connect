...
export const countries: Country[] = [
  ...
  { name: "Antigua-et-Barbuda", code: "AG", dialCode: "+1-268", flag: "🇦🇬" },
  ...
  { name: "Barbade", code: "BB", dialCode: "+1-246", flag: "🇧🇧" },
  ...
  { name: "Dominique", code: "DM", dialCode: "+1-767", flag: "🇩🇲" },
  ...
  { name: "Grenade", code: "GD", dialCode: "+1-473", flag: "🇬🇩" },
  ...
  { name: "Jamaïque", code: "JM", dialCode: "+1-876", flag: "🇯🇲" },
  ...
  { name: "République dominicaine", code: "DO", dialCode: "+1-809", flag: "🇩🇴" },
  ...
  { name: "Saint-Kitts-et-Nevis", code: "KN", dialCode: "+1-869", flag: "🇰🇳" },
  { name: "Saint-Vincent-et-les-Grenadines", code: "VC", dialCode: "+1-784", flag: "🇻🇨" },
  { name: "Sainte-Lucie", code: "LC", dialCode: "+1-758", flag: "🇱🇨" },
  ...
  { name: "Trinité-et-Tobago", code: "TT", dialCode: "+1-868", flag: "🇹🇹" },
...
export function getDialCodeByCountryName(name: string): string {
