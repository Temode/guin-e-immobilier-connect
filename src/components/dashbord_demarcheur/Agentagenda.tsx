  ...
  const navSections = [
    {
      ...
      items: [
        ...
        { icon: CalendarIcon, label: 'Agenda & Visites', active: true, badge: 3, badgeUrgent: true },
      ],
    },
    {
      title: 'Communication',
    ...
    <aside className={styles.sidebar}>
      ...
      <div className={styles.sidebarFooter}>
        <div className={styles.premiumCard}>
          ...
          <p>Boostez vos annonces</p>
          <button className={`${styles.btn} ${styles.btnGold} ${styles.btnSm}`}>Découvrir</button>
        </div>
      </div>
    </aside>
  );
