  ...
  const navSections = [
    {
      ...
      items: [
        ...
        { icon: BuildingIcon, label: 'Mes biens', active: true, badge: 12, badgeGold: true },
    ...
    {
      title: 'Finances',
      items: [{ icon: CurrencyIcon, label: 'Commissions' }],
    },
    {
      title: 'Communication',
      items: [
    ...
    {
      title: 'Compte',
      items: [{ icon: UserIcon, label: 'Profil & Paramètres' }],
    },
  ];
